...
| Enable notifications | Notifies you about long-running auto-approved commands | Located at the bottom of the Auto Approve menu |
...
The "Enable notifications" toggle is located at the bottom of the Auto Approve menu, making it easy to access alongside your other auto-approve settings.
